      ...
      <div className="flex-1 py-12 md:py-24 space-y-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div>
                ...
                <CardDescription>My academic journey and projects</CardDescription>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Exploring the world of programming, algorithms, and software development.
              </p>
              <Link href="/cs" className="mt-4 inline-block text-sm font-medium text-primary hover:underline">
                Learn more →
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-muted-foreground">Capturing moments and creating visual stories through my lens.</p>
              <Link href="/photography" className="mt-4 inline-block text-sm font-medium text-primary hover:underline">
                View gallery →
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Tapping, sliding, and hitting to the beat in various rhythm games.
              </p>
              <Link href="/rhythm-games" className="mt-4 inline-block text-sm font-medium text-primary hover:underline">
                See my scores →
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Enjoying the fast-paced, strategic game of pickleball on and off the court.
              </p>
              <Link href="/pickleball" className="mt-4 inline-block text-sm font-medium text-primary hover:underline">
                Discover more →
              </Link>
            </CardContent>
          </Card>
